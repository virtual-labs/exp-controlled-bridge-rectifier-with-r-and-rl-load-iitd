const sliders = {
    ...
    sliderD(afterClickCallback=null){
        ...
        let val = 0
        let maxRange = this.d_max
        let minRange = this.d_min 
        let stepSize = this.d_step
    ...
    changeCircuitImage(step){
        let circuitImgSrc = "./src/images/sliders/slider_circuit_2.png" 
        if(step == "r"){
            circuitImgSrc = "./src/images/sliders/slider_circuit_2.png"
        }else if(step == "rl"){
            circuitImgSrc = "./src/images/sliders/slider_circuit_3_rl.png"
        }
        $(".slider-circuit").attr("src",  circuitImgSrc)
    }
}
